...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="pt-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 relative overflow-hidden">
        <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[1, 2, 3].map((index) => (
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
                className="aspect-w-9 aspect-h-16 rounded-xl overflow-hidden shadow-lg"
              >
                <iframe
                  src={`https://www.youtube.com/embed/your-short-${index}`}
